					...
					<div class="portlet light tasks-widget">
						...
						<div class="portlet-body">
							<form class="form-inline margin-bottom-10" action="#">
								<div class="input-group">
									<input type="text" class="form-control" id="gmap_geocoding_address" placeholder="adresse..." value="<?php echo $donnees['f_adresse'] . ' ' . $donnees['f_code_postal'] . ' ' . $donnees['f_ville']; ?>">
